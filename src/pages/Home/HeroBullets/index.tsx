    ...
    <Container size="md">
      <div className={classes.inner}>
        ...
        >
          ...
          <List.Item>
            <b>Server Management Tools</b> – Manage your banlist, keep track of
            unwanted users, and ensure your server runs smoothly.
          </List.Item>
          <List.Item>
            <b>Real-Time Server Statistics</b> – View live data from your
            server, including player counts and activity trends, displayed in an
            intuitive chart format.
          </List.Item>
        </List>
